...
int main()
{
    ...
    pantalla_altaForzada(array,QTY,"Avellaneda","Belgrano 250",100,0);
    pantalla_altaForzada(array,QTY,"Bernal","Cerrito 300",5000,0);
    ...
    do
    {
        ...
        switch(menu)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                listar_ordenarPrecioNombre(array,QTY);
                pantalla_mostrar(array,QTY);
                break;
            case 9:
            ...
            case 10:
                ...
                break;
            case 11:
                listar_superaPromedioDias(array,contrataciones, LEN_CONT);
                break;
