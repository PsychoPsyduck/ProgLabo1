...
int main()
{
    ...
    cliente_altaForzada(listaClientes,LEN_CLIENTES,"Nicolas","Sande", 37954192, 1);
    cliente_altaForzada(listaClientes,LEN_CLIENTES,"Gatin","Tuca", 35654654, 5);
    publicacion_altaForzada(listaAvisos,LEN_AVISOS, 1 , 1 ,"comida");
    ...
    do
    {
        ...
        switch(menu)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                publicacion_alta(listaAvisos,LEN_AVISOS);
                break;
            case 5:
            ...
            case 8:
                ...
                break;
            case 9:
                informe_masAvisos(listaClientes,LEN_CLIENTES);
                break;
            case 10:
